...
function Urdubook() {
  ...
  const categoryData = data?.find(book => book.category === "urdubook");
  ...
  // const imageArray = allBooks.image2.split('\n');
    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 px-4 lg:px-30">
        {booksToRender.map((book) => (
          ...
          >
            {/* Image */}
            <Link to={`/products/urdubook/${book.id}`}>
